...
public class VentanaPrincipal extends JFrame{
        ...
        btnRegistrarse.addActionListener(new ActionListener(){
                ...
                public void actionPerformed(ActionEvent e){
                    ...
                    if(correoElectronico.equals("")){
                        ...
                        aux = 1;
                    }else if(correoElectronico.contains("@")==false && confirmarContrasena.contains(".com")){
                        JOptionPane.showMessageDialog(VentanaPrincipal.this,"CORREO ELECTRONICO ERRONEO");
                        txtCorreoElectronico.setBackground(Color.RED);
                        txtCorreoElectronico.selectAll();
                        txtCorreoElectronico.requestFocus();
                        aux = 1;
    ...
    private void comprobarCorreo(JTextField introText) {
        ...
        while(it.hasNext()){
            ...
            String correoelec = user.getCorreo();

            if(correoelec.equals(correo)){
